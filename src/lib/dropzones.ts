...
export const DROPZONES: Dropzone[] = [
  ...
  { name: 'Besançon-La Vèze', country: 'France', lat: 47.206615, lng: 6.083168 },
  ...
  { name: 'Tandemotion (Chambley)', country: 'France', lat: 49.025501, lng: 5.87607 },
  ...
  { name: 'Merville-Calonne', country: 'France', lat: 50.618401, lng: 2.64224 },
